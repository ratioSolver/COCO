                            ...
                            {{"type", "object"},
                             ...
                             {"properties",
                              {{"name", {{"type", "string"}, {"description", "The unique name identifier for this type."}}},
                               ...
                               {"static_properties", {{"type", "array"}, {"items", {"$ref", "#/components/schemas/property"}}, {"description", "Array of static properties that define the fixed structure of items of this type."}}},
                               {"dynamic_properties", {{"type", "array"}, {"items", {"$ref", "#/components/schemas/property"}}, {"description", "Array of dynamic properties that can store time-series data for items of this type."}}},
