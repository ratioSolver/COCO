...
int main()
{
    ...
    cc.create_reactive_rule("set_name", "(defrule set_name ?f <- (entity (item_id ?robot) (name user_name) (value ?value)) (Robot_has_user (item_id ?robot) (user ?user)) => (set_slots ?user (create$ user_name) (create$ ?value)) (retract ?f))");
    // If the message contains the age of the user, set the age of the user
    cc.create_reactive_rule("set_age", "(defrule set_age ?f <- (entity (item_id ?robot) (name user_age) (value ?value)) (Robot_has_user (item_id ?robot) (user ?user)) => (set_slots ?user (create$ user_age) (create$ ?value)) (retract ?f))");
