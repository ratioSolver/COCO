...
=>
    ...
    (if (and ?psychiatric_patients ?bar_restaurant) then (bind ?physical_fatigue_relevant (append$ ?physical_fatigue_relevant bar_restaurant)))
    (if (and ?psychiatric_patients ?water_fountains) then (bind ?physical_fatigue_relevant (append$ ?physical_fatigue_relevant water_fountains)))
    (if (and (or ?parkinson ?psychiatric_patients ?multiple_sclerosis ?young_pci_autism) (>= ?heart_rate 100)) then (bind ?physical_fatigue_relevant (append$ ?physical_fatigue_relevant heart_rate)))
    (if (and (or ?psychiatric_patients ?young_pci_autism) (>= ?baseline_heart_rate 100)) then (bind ?physical_fatigue_relevant (append$ ?physical_fatigue_relevant baseline_heart_rate)))
    (if (and (or ?parkinson ?psychiatric_patients ?older_adults ?multiple_sclerosis ?young_pci_autism) (>= ?respiratory_rate 30)) then (bind ?physical_fatigue_relevant (append$ ?physical_fatigue_relevant respiratory_rate)))
    (if (and ?psychiatric_patients ?sittings) then (bind ?physical_fatigue_relevant (append$ ?physical_fatigue_relevant sittings)))
