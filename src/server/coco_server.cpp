                            ...
                            {{"type", "object"},
                             {"properties",
                              {{"type", {{"type", "string"}, {"enum", {"int"}}}},
                               ...
                               {"default", {{"oneOf", std::vector<json::json>{{{"type", "integer"}}, {{"type", "array"}, {"items", {{"type", "integer"}}}}}}}},
                               {"min", {{"type", "integer"}}},
                               {"max", {{"type", "integer"}}}}},
                            ...
                            {{"type", "object"},
                             {"properties",
                              {{"type", {{"type", "string"}, {"enum", {"float"}}}},
                               {"multiple", {{"type", "boolean"}}},
                               {"default", {{"oneOf", std::vector<json::json>{{{"type", "number"}}, {{"type", "array"}, {"items", {{"type", "number"}}}}}}}},
                               {"min", {{"type", "number"}}},
                               {"max", {{"type", "number"}}}}},
                             {"required", std::vector<json::json>{"type"}}}},
                           {"string_property",
                                     ...
                                     {"/items/{id}",
                                      {{"get",
                                        {{"summary", "Retrieve a specific " COCO_NAME " item"},
                                         {"description", "Endpoint to fetch a specific item by name"},
                                         {"parameters",
