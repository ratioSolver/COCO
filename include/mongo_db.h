...
namespace coco
{
  ...
  public:
    ...
    void set_user_admin(user &u, bool admin) override;
    void set_user_admin(const std::string &id, bool admin) override;
    ...
    void set_sensor_data(sensor &s, const std::chrono::system_clock::time_point &time, const json::json &val) override;
