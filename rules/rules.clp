...
(deftemplate task (slot solver_ptr (type INTEGER)) (slot id (type SYMBOL)) (slot task_type (type SYMBOL)) (multislot pars (type SYMBOL)) (multislot vals) (slot since (type INTEGER) (default 0)))
