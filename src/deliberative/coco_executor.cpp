...
namespace coco
{
    ...
    void coco_executor::current_flaw(std::optional<utils::ref_wrapper<ratio::flaw>> f) { cd.current_flaw(*this, f); }
    ...
    void coco_executor::current_resolver(std::optional<utils::ref_wrapper<ratio::resolver>> r) { cd.current_resolver(*this, r); }
    ...
    void coco_executor::starting(const std::vector<utils::ref_wrapper<riddle::atom_term>> &atms) { cd.starting(*this, atms); }
    void coco_executor::start(const std::vector<utils::ref_wrapper<riddle::atom_term>> &atms) { cd.start(*this, atms); }
    void coco_executor::ending(const std::vector<utils::ref_wrapper<riddle::atom_term>> &atms) { cd.ending(*this, atms); }
    void coco_executor::end(const std::vector<utils::ref_wrapper<riddle::atom_term>> &atms) { cd.end(*this, atms); }
#endif
} // namespace coco
