...
namespace coco
{
  ...
  const json::json reactive_rule_path{"/reactive_rule",
                                      {{"post",
  ...
  const json::json update_reactive_rule_path{"/reactive_rules/{rule_id}",
                                             {{"delete",
                                              ...
                                              {"responses",
                                               {{"200",
                                                 {{"description", "Successful response with the stored deliberative rules"},
                                                  {"content", {{"application/json", {{"schema", {{"type", "array"}, {"items", {{"$ref", "#/components/schemas/coco_rule"}}}}}}}}}}}}}}}}};
  const json::json deliberative_rule_path{"/deliberative_rule",
                                          {{"get",
                                            {{"summary", "Retrieve all the CoCo deliberative rules"},
                                             {"description", "Endpoint to fetch all the managed deliberative rules"},
                                             {"responses",
                                              {{"200",
                                                {{"description", "Successful response with the stored deliberative rules"},
                                                 {"content", {{"application/json", {{"schema", {{"type", "array"}, {"items", {{"$ref", "#/components/schemas/coco_rule"}}}}}}}}}}}}}}}}};
  const json::json update_deliberative_rule_path{"/deliberative_rules/{rule_id}",
                                                 {{"delete",
